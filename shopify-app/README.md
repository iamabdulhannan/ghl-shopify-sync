...
> **Note:** this lives in the same repo as the open-source standalone connector (`../`). Open-source = self-host, MIT. This app = paid SaaS, embedded in Shopify admin.
...
2. **Add app listing assets** in Partner Dashboard:
   ...
   - App description (use the value prop from `../README.md`)
...
This subdirectory is **proprietary** — not MIT. The standalone connector at `../` is MIT.
